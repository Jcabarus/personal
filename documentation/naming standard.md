File Name
    ...
    The use of '-' as a substitution for whitespace is prohibited but using whitespace before '-' is recommended
...
File Directory
    ...
    The use of capitalization are not allowed
    The use of special characters are not allowed
